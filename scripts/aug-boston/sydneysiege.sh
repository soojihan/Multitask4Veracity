...
python /mnt/fastdata/acp16sh/newbaseline/src/outer.py --model='mtl2detect' --data='pheme5' --fname='sydneysiege' --search=True --ntrials=20 --train_path='/mnt/fastdata/acp16sh/newbaseline/data/aug-boston/sydneysiege/train' --heldout_path='/mnt/fastdata/acp16sh/newbaseline/data/aug-boston/sydneysiege/heldout' --test_path='/mnt/fastdata/acp16sh/newbaseline/data/aug-boston/sydneysiege/test' --save_path='/mnt/fastdata/acp16sh/newbaseline/output/aug-boston/sydneysiege'
