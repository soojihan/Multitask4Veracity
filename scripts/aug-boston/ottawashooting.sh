...
python /mnt/fastdata/acp16sh/newbaseline/src/outer.py --model='mtl2detect' --data='pheme5' --fname='ottawashooting' --search=True --ntrials=20 --train_path='/mnt/fastdata/acp16sh/newbaseline/data/aug-boston/ottawashooting/train' --heldout_path='/mnt/fastdata/acp16sh/newbaseline/data/aug-boston/ottawashooting/heldout' --test_path='/mnt/fastdata/acp16sh/newbaseline/data/aug-boston/ottawashooting/test' --save_path='/mnt/fastdata/acp16sh/newbaseline/output/aug-boston/ottawashooting'
