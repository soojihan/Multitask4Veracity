...
python /mnt/fastdata/acp16sh/newbaseline/src/outer.py --model='mtl2detect' --data='pheme5' --fname='germanwings' --search=True --ntrials=20 --train_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/germanwings/train' --heldout_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/germanwings/heldout' --test_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/germanwings/test' --save_path='/mnt/fastdata/acp16sh/newbaseline/output/pheme/germanwings'
