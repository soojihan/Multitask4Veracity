...
python /mnt/fastdata/acp16sh/newbaseline/src/outer.py --model='mtl2detect' --data='pheme5' --fname='ottawashooting' --search=True --ntrials=20 --train_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/ottawashooting/train' --heldout_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/ottawashooting/heldout' --test_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/ottawashooting/test' --save_path='/mnt/fastdata/acp16sh/newbaseline/output/pheme/ottawashooting'
