...
python /mnt/fastdata/acp16sh/newbaseline/src/outer.py --model='mtl2detect' --data='pheme5' --fname='charliehebdo' --search=True --ntrials=20 --train_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/charliehebdo/train' --heldout_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/charliehebdo/heldout' --test_path='/mnt/fastdata/acp16sh/newbaseline/data/pheme/charliehebdo/test' --save_path='/mnt/fastdata/acp16sh/newbaseline/output/pheme/charliehebdo'
