...
python /mnt/fastdata/acp16sh/newbaseline/src/outer.py --model='mtl2detect' --data='pheme5' --fname='ferguson' --search=True --ntrials=20 --train_path='/mnt/fastdata/acp16sh/newbaseline/data/aug/ferguson/train' --heldout_path='/mnt/fastdata/acp16sh/newbaseline/data/aug/ferguson/heldout' --test_path='/mnt/fastdata/acp16sh/newbaseline/data/aug/ferguson/test' --save_path='/mnt/fastdata/acp16sh/newbaseline/output/aug/ferguson'
