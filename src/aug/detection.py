...
def objective_MTL2_detection_CV5(params):
    path ="/mnt/fastdata/acp16sh/Multitask4Veracity/data/final/aug-equal-balance"
    # test_path = "/mnt/fastdata/acp16sh/Multitask4Veracity/data/final/pheme-equal-balance"
...
def eval_MTL2_detection_CV(params, data, fname):
    path ="/mnt/fastdata/acp16sh/Multitask4Veracity/data/final/backup/aug-1306"
    test_path = "/mnt/fastdata/acp16sh/Multitask4Veracity/data/final/pheme-equal-balance"
    print("path ", path)
    ...
    directory = "/mnt/fastdata/acp16sh/Multitask4Veracity/output-test/aug"
    print(directory)
